...
public class LogConstants {
    ...
    protected static final String HOST_SEPERATOR         = ".eanadev.org";
    protected static final String WSKEY                  = "wsKey";
    protected static final String DATE_FORMAT            = "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'";
    protected static final String TIME_ZONE              = "UTC";
    protected static final String SERVER_TIMEZONE_OFFSET = "+00:00";
